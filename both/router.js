...
Router.map(function() {
  ...
  this.route('login');  
  this.route('home');
  this.route('SellOrRetain'); 
  this.route('assetMonitor'); 
  this.route('cattleHome'); 
  this.route('cropsHome'); 
  this.route('updateCattle'); 
  this.route('addCattle'); 
  this.route('addCrop');
  this.route('updateCrop');
